...
//   todos[1].done = true;
//
//   TodoResult save_res = todo_save(TEST_FILE, todos, count);
...
//
//   TodoResult load_res =
//       todo_load(TEST_FILE, &loaded_todos, &load_capacity, &load_count);
...
//     return false;
//
//   TodoResult res = todo_load("nonexistent_file.txt", &todos, &capacity,
//   &count); ASSERT_TRUE(res == TODO_ERR_FILE);
//
//   free(todos);
//   return true;
// }
